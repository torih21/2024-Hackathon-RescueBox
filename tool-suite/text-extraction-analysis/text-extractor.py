# credit: g-stavrakis https://github.com/g-stavrakis/PDF_Text_Extraction/blob/main/README.md
...
def crop_image(element, pageObj):
    ...
    with open('cropped-image.pdf', 'wb') as cropped_pdf_file:
    ...
    for i,component in enumerate(page_elements):
        ...
        if not is_element_inside_any_table(element,page,tables):
            ...
            if isinstance(element, LTFigure):
                ...
                convert_to_images('test-analysis.pdf')
